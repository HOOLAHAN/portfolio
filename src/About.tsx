  ...
  return (
    ...
    >
      ...
      <Box flex="1" minW={{ lg: "50%" }}>
        <Text mb={6}>Hi, I'm Iain! A software engineer with a foundation in civil engineering and a robust track record of problem-solving, continuous learning, and collaborative innovation. Having transitioned from civil engineering to software development, my rigorous training at Makers Academy's 16-week coding bootcamp has greatly enhanced my technical skills, especially in Full Stack Development using technologies like React, Node.js, and AWS.</Text>
